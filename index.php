      ...
      <div class="row">
        <div class="col-md-12">
          <div class="banner-text">
            <h2>Bienvenue sur <span>Travel France</span></h2>
            <p>Le meilleur site de découverte de la France</p>
            <a href='lieu.php' class="banner-button">Index des Sites de visite</a>
            <a href='form.html' class="banner-button">Recherche Sites par ville</a> </div>
        </div>
      </div>
    </div>
  </div>
