...
$query = "select distinct ?name ?lien ?texte ?ville ?image  where{
    ...
    optional{
        ...
        ?lien <http://dbpedia.org/ontology/thumbnail> ?image .
        minus {filter (regex(str(?ville), 'France'))}
        minus {filter (regex(str(?ville), 'arrondissement'))}
    }   
}
";
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-md-4"> <span class="copyright">Copyright &copy; Travel France</span> </div>
      <div class="col-md-4">

      </div>
      <div class="col-md-4">
        <ul class="list-inline quicklinks">
          <li>Designed by <a href="http://w3template.com">Travel Franc</a> </li>
        </ul>
      </div>
    </div>
  </div>
